...
$(document).ready(function(){
    ...
    $('[data-accordeon-group]').each(function(){
        var group = $(this).data('accordeon-group');
        var groupTogglers = $('[data-accordeon-group="' + group + '"]').find('[data-accordeon-toggle]');
        var groupContents = $('[data-accordeon-group="' + group + '"]').find('[data-accordeon-content]');
        var toggler = $(this).find('[data-accordeon-toggle]');
        var content = $(this).find('[data-accordeon-content]');
    ...
    $('[data-maps-panto]').click(function(){
        var coordinates = $(this).data('maps-panto').split(",");
